# Velo Payments OpenAPI OpenAPI Specification
[![Build Status](https://travis-ci.com/velopaymentsapi/VeloOpenApi.svg?branch=master)](https://travis-ci.com/velopaymentsapi/VeloOpenApi)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://velopaymentsapi.github.io/VeloOpenApi/)
- [SwaggerUI](https://velopaymentsapi.github.io/VeloOpenApi/swagger-ui/)
- OpenAPI Raw Files: [JSON](https://velopaymentsapi.github.io/VeloOpenApi/openapi.json) [YAML](https://velopaymentsapi.github.io/VeloOpenApi/openapi.yaml)
